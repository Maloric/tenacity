...
requirejs.config({
    ...
    paths: {
        ...
        'baseComponent'             :   'tenacity/components/baseComponent',
        'baseModel'                 :   'tenacity/models/baseModel',
        'debugComponent'            :   'tenacity/components/debugComponent',
        'debugEventComponent'       :   'tenacity/components/debugEventComponent',
